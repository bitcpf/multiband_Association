...
better. There are a lot of work talk about the channel state estimation\cite{gan2013multiple}.%more!!!
In these works, 
% About fading channel
They focus on reducing the feedback information from the clients%\cite{}
Other works are focus on the improve the accuracy of single value channel 
state estimation %\cite{}
% channel forecast
